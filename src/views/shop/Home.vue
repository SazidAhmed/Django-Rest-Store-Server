            ...
            <!-- cards -->
                <div class="card relative" v-for="product in latestProducts" :key="product.id">
                    ...
                    <div class="m-2 flex justify-evenly">
                        ...
                        <router-link :to="product.get_absolute_url" class="rounded-full py-1 px-2 text-xs font-bold cursor-pointer tracking-wider border-gray-500 md:border-2 text-gray hover:bg-gray-500 hover:text-white transition ease-out duration-500">
